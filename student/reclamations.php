...
// Base query for reclamations
$sql = "FROM tickets t JOIN categories c ON c.id = t.category_id WHERE t.user_id = :user_id AND t.type = 'complaint' AND t.status != 'draft'";
            ...
            <table class="table table-hover mb-0 align-middle">
                ...
                <tbody>
                    <?php if(empty($tickets)): ?>
                        <tr><td colspan="6" class="text-center p-4 text-muted">Aucune réclamation trouvée.</td></tr>
                    <?php else: ?>
                        <?php foreach($tickets as $t): ?>
                            ...
                            ?>
                            <tr>
                                <td class="px-4"><span class="font-monospace fw-bold text-danger" style="font-size:0.85rem;"><?= e($t['reference']) ?></span></td>
